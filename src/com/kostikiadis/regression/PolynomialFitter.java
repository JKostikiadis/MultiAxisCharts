 ...
 * good luck - it's like talking to a brick wall.
 */
public class PolynomialFitter {
	...
	/**
	 * Returns a polynomial that seeks to minimize the square of the total distance
	 * between the set of points and the polynomial.
	 * 
	 * @return A polynomial
	 */
